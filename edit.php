        ...
        <form id="editForm" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="nama_mahasiswa" class="form-control" 
                       ...
                       value="<?php echo htmlspecialchars($mahasiswa['nama_mahasiswa']); ?>">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <select name="jurusan" class="form-control" required>
                    ...
                    <?php
                    // Tampilkan jurusan berdasarkan fakultas yang sedang dipilih (data awal)
